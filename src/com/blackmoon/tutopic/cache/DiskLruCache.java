...
import com.blackmoon.tutopic.exception.InsufficientStorageException;
...
public class DiskLruCache {
     ...
     * @throws IOException
     */
    public static DiskLruCache openCache(Context context, File cacheDir, long maxByteSize) throws IOException,
            InsufficientStorageException {
        if (!cacheDir.exists()) {
            cacheDir.mkdir();
        }
        if (CacheUtils.getUsableSpace(cacheDir) <= maxByteSize) {
